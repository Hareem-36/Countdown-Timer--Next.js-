...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-purple-200 dark:bg-lightblue-900">
<br></br>
<Image
                        src={profile}
                        alt="profile pic"
                    ...
                    /><br></br>
      {/* Timer box container */}
      <h2 className="text-4xl font-bold underline mb-6 text-gray-900 dark:text-black-300">
  Hareem Jaweid's Countdown Timer
</h2>


      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-black-800 dark:text-black-200 text-center">
          Countdown Timer
        </h1>
